...
public final class InMemoryConnectionStore implements ResumptionSupportingConnectionStore {
	...
	@Override
	public synchronized boolean replace(final Connection previousConnection, final Connection newConnection) {
		remove(previousConnection, false);
		return put(newConnection);
	}
